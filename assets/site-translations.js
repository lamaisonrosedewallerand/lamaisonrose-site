...
const UI_TRANSLATIONS = {
  ...
  en: {
    ...
    event: {
      ...
      loadingUpcoming: "Loading upcoming dates…",
      loadingPast: "Loading programme archives…",
      emptyFeatured: "No featured event at the moment.",
      emptyUpcoming: "No other upcoming date at the moment.",
      emptyPast: "Programme archives will appear here."
    },
    helloasso: {
      noWidget:
...
const STATIC_PAGE_COPY = {
  index: {
    ...
    nodes: [
      ...
      { selector: ".hero-ticket .ticket-callout__eyebrow", text: { fr: "Billetterie cours & stages", en: "Courses & workshops booking" } },
      { selector: ".hero-ticket .ticket-callout__title", text: { fr: "Réserver un atelier à la Maison Rose", en: "Book a workshop at the Pink House" } },
      { selector: ".hero-ticket .ticket-callout__copy", text: { fr: "Retrouvez les prochains cours et stages ouverts à l’inscription, puis accédez aux liens de réservation ou de contact.", en: "Find the next courses and workshops open for registration, then access the booking links or the right contact." } },
      { selector: ".hero-ticket .ticket-callout__link", html: { fr: "Voir les stages <span class=\"arr\">→</span>", en: "See workshops <span class=\"arr\">→</span>" } },
  ...
  stages: {
    ...
    nodes: [
      ...
      { selector: ".stages-ticket .ticket-callout__eyebrow", text: { fr: "Billetterie cours & stages", en: "Courses & workshops booking" } },
      { selector: ".stages-ticket .ticket-callout__title", text: { fr: "Parcourir les ateliers ouverts à l’inscription", en: "Browse workshops open for registration" } },
      { selector: ".stages-ticket .ticket-callout__copy", text: { fr: "Une entrée simple pour repérer les prochains stages, consulter les dates et rejoindre les liens d’inscription quand ils sont ouverts.", en: "A simple way to spot upcoming workshops, check the dates and access registration links when they are open." } },
      { selector: ".stages-ticket .ticket-callout__link", html: { fr: "Voir la billetterie <span class=\"arr\">→</span>", en: "Open booking <span class=\"arr\">→</span>" } },
  ...
  events: {
    ...
    description: {
      fr: "Expositions, concerts, conférences, ateliers, stages et rendez-vous publics : l'agenda de la Maison Rose de Wallerand à Auvers-sur-Oise.",
      en: "Exhibitions, concerts, talks, workshops and public gatherings: the full agenda of the Pink House of Wallerand in Auvers-sur-Oise."
    },
    nodes: [
      ...
      { selector: ".agenda .sec-head .right", text: { fr: "Le programme rassemble les rendez-vous à venir, y compris les stages datés, et garde la mémoire des archives au même endroit.", en: "The programme gathers upcoming dates, including dated workshops, while keeping the archive in the same place." } },
  ...
  join: {
    ...
    nodes: [
      ...
      { selector: ".tiers .tier:nth-child(1) li:nth-child(1)", text: { fr: "Soutenir la Maison Rose et suivre de près sa programmation", en: "Support the Pink House and stay close to its programme" } },
      { selector: ".tiers .tier:nth-child(1) li:nth-child(2)", text: { fr: "Accès prioritaire aux événements, conférences et rencontres selon les jauges", en: "Priority access to events, talks and encounters depending on capacity" } },
      { selector: ".tiers .tier:nth-child(1) li:nth-child(3)", text: { fr: "Tarif adhérent possible sur certains cours et stages, selon la programmation", en: "Member pricing possible on selected courses and workshops, depending on the programme" } },
      { selector: ".tiers .tier:nth-child(1) li:nth-child(4)", text: { fr: "Adhésion et confirmations centralisées sur HelloAsso", en: "Membership and confirmations remain centralised on HelloAsso" } },
      ...
      { selector: ".tiers .tier:nth-child(2) .lvl", text: { fr: "— Famille", en: "— Family" } },
      { selector: ".tiers .tier:nth-child(2) h3", text: { fr: "Adhésion famille", en: "Family membership" } },
      { selector: ".tiers .tier:nth-child(2) .price .b", text: { fr: "par an", en: "per year" } },
      { selector: ".tiers .tier:nth-child(2) li:nth-child(1)", text: { fr: "Une formule pensée pour les parents, les enfants et les proches de la Maison Rose", en: "A formula designed for parents, children and those close to the Pink House" } },
      { selector: ".tiers .tier:nth-child(2) li:nth-child(2)", text: { fr: "Les mineurs sont accueillis gratuitement dans le cadre familial", en: "Minors are welcomed free of charge within the family format" } },
      { selector: ".tiers .tier:nth-child(2) li:nth-child(3)", text: { fr: "Accès prioritaire aux événements, conférences et rendez-vous selon les jauges", en: "Priority access to events, talks and encounters depending on capacity" } },
      { selector: ".tiers .tier:nth-child(2) li:nth-child(4)", text: { fr: "Tarif adhérent possible sur certains cours et stages, sans engagement systématique", en: "Member pricing possible on selected courses and workshops, without it being systematic" } },
      { selector: ".tiers .tier:nth-child(2) li:nth-child(5)", text: { fr: "Adhésion et confirmations gérées directement sur HelloAsso", en: "Membership and confirmations handled directly on HelloAsso" } },
