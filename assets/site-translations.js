...
const STATIC_PAGE_COPY = {
  ...
  lieu: {
    ...
    nodes: [
      ...
      { selector: ".visit .sec-head .left h2", html: { fr: "Venir à <span class=\"it\">la Maison.</span>", en: "Visiting <span class=\"it\">the house.</span>" } },
      ...
      { selector: ".visit-card .row:nth-child(7) .v", text: { fr: "Gratuit à 100 m de la Maison", en: "Free parking 100 m from the house" } },
      ...
      { selector: ".visit-text .btn-primary", html: { fr: "Visiter la Maison <span class=\"arr\">→</span>", en: "Visit the House <span class=\"arr\">→</span>" } },
  ...
  contact: {
    ...
    nodes: [
      ...
      { selector: ".page-hero h1", html: { fr: "<span class=\"line\">Nous écrire,</span><span class=\"line\"><em>venir à la Maison.</em></span>", en: "<span class=\"line\">Write to us,</span><span class=\"line\"><em>come and visit.</em></span>" } },
  ...
  wallerand: {
    ...
    nodes: [
      ...
      { selector: ".w-text p:last-of-type", text: { fr: "De 2014 à 2021, Wallerand redonne à la Maison Rose sa vocation d'atelier et de foyer d'artistes. L'association poursuit aujourd'hui cet héritage vivant.", en: "From 2014 to 2021, Wallerand restored the Pink House as both a studio and an artists' home. The association continues that living legacy today." } },
