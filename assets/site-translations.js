...
const STATIC_PAGE_COPY = {
  ...
  lieu: {
    ...
    nodes: [
      ...
      { selector: ".visit .sec-head .right", text: { fr: "Quelques vues pour prendre la mesure du lieu, puis une visite photo complète avant de pousser la porte de la Maison Rose.", en: "A few first views to sense the scale of the place, then a complete photo visit before stepping inside the Pink House." } },
