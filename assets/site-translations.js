...
const STATIC_PAGE_COPY = {
  index: {
    ...
    nodes: [
      ...
      { selector: ".hero .hv-tag.t1 .lbl", text: { fr: "Maison Rose", en: "Pink House" } },
      { selector: ".hero .hv-tag.t1 .val", html: { fr: "<strong>156 m²</strong> · atelier &amp; résidence", en: "<strong>156 m²</strong> · studio &amp; residency" } },
      { selector: ".hero .hv-tag.t2 .lbl", text: { fr: "Accès", en: "Access" } },
      { selector: ".hero .hv-tag.t2 .val", html: { fr: "<strong>10 min gare</strong> · parking à 100 m", en: "<strong>10 min station</strong> · parking 100 m away" } },
  ...
  lieu: {
    ...
    nodes: [
      ...
      { selector: ".page-hero .lede", text: { fr: "À 10 minutes à pied de la gare d'Auvers-sur-Oise, la Maison Rose de Wallerand redonne vie à l'ancien atelier d'été de Charles-François Daubigny.", en: "A 10-minute walk from Auvers-sur-Oise station, the Pink House of Wallerand gives new life to Charles-François Daubigny's former summer studio." } },
      ...
      { selector: ".history .history-text p:nth-of-type(2)", text: { fr: "Depuis, le lieu garde sa vocation de foyer d'artistes. Wallerand y vit de 2014 à 2021 et redonne à la Maison Rose son élan de résidence, d'exposition et de transmission.", en: "Since then, the house has kept its identity as an artists' home. Wallerand lived here from 2014 to 2021 and restored the Pink House as a residency, exhibition and transmission space." } },
      ...
      { selector: ".timeline .ev:nth-child(3) h4", text: { fr: "Karl Daubigny prolonge l'héritage", en: "Karl Daubigny extends the legacy" } },
      { selector: ".timeline .ev:nth-child(3) p", text: { fr: "Jusqu'à sa mort en 1886, Karl Daubigny poursuit à Auvers l'histoire familiale et l'ancrage artistique du lieu.", en: "Until his death in 1886, Karl Daubigny carries the family's artistic legacy forward in Auvers." } },
      { selector: ".timeline .ev:nth-child(4) h4", text: { fr: "Wallerand s'y installe", en: "Wallerand settles here" } },
      { selector: ".timeline .ev:nth-child(4) p", text: { fr: "Le peintre redonne au lieu sa vocation d'atelier, de résidence et de foyer d'artistes.", en: "The painter restores the house as a studio, residency and artists' home." } },
      ...
      { selector: ".visit .sec-head .right", text: { fr: "Un aperçu du lieu, puis des informations pratiques pour préparer une venue, une résidence ou une visite.", en: "An overview of the house, followed by practical information for planning a visit, a residency or a stay." } },
      ...
      { selector: ".visit-gallery .sec-head .right", text: { fr: "Façade, chambre, patio, verrière, accrochage et pièces de vie : une visite photo plus fluide pour prolonger la découverte avant votre venue.", en: "Front façade, bedroom, patio, glass roof, hanging walls and living rooms: a smoother photo visit before coming in person." } },
  ...
  stages: {
    ...
    nodes: [
      ...
      { selector: ".filters [data-f=\"all\"]", text: { fr: "Tous les cours et stages", en: "All courses & workshops" } },
      { selector: ".filters [data-f=\"gravure\"]", text: { fr: "Gravure", en: "Engraving" } },
      { selector: ".filters [data-f=\"other\"]", text: { fr: "Autres pratiques", en: "Other practices" } },
      { selector: ".filters [data-f=\"deb\"]", text: { fr: "Débutant", en: "Beginner" } },
      { selector: ".filters [data-f=\"int\"]", text: { fr: "Intermédiaire", en: "Intermediate" } },
      { selector: ".filters [data-f=\"adv\"]", text: { fr: "Avancé", en: "Advanced" } },
      { selector: ".filters [data-f=\"open\"]", text: { fr: "Ouverts", en: "Open" } },
      ...
      { selector: ".info-grid .info-card:nth-child(1) p", text: { fr: "La programmation commence aujourd'hui par la gravure, mais le système est pensé pour accueillir aussi le chant, la sculpture et d'autres pratiques à venir.", en: "The programme begins with engraving today, but the structure is ready to welcome singing, sculpture and other practices in the future." } },
      { selector: ".info-grid .info-card:nth-child(2) h4", text: { fr: "Inscriptions", en: "Registrations" } },
      { selector: ".info-grid .info-card:nth-child(2) p", text: { fr: "Chaque fiche peut afficher un lien HelloAsso, un contact d'inscription ou des précisions sur la discipline, pour laisser l'association autonome dans ses mises à jour.", en: "Each card may display a HelloAsso link, a registration contact or discipline details, keeping content management simple for the association." } },
      { selector: ".info-grid .info-card:nth-child(3) h4", text: { fr: "Rythme", en: "Rhythm" } },
      { selector: ".info-grid .info-card:nth-child(3) p", text: { fr: "Le programme évolue au fil de la saison. Quand aucun cours ou stage n'est annoncé, les archives restent consultables en attendant les prochaines dates.", en: "The programme evolves through the season. When no course or workshop is announced, the archives remain available until the next dates are confirmed." } }
    ]
  },
  events: {
    title: {
  ...
  contact: {
    ...
    nodes: [
      ...
      { selector: ".ct-form select option:nth-child(6)", text: { fr: "Événement ou exposition", en: "Event or exhibition" } },
      { selector: ".ct-form select option:nth-child(7)", text: { fr: "Presse & partenariats", en: "Press & partnerships" } },
      { selector: ".ct-form select option:nth-child(8)", text: { fr: "Autre", en: "Other" } },
  ...
  wallerand: {
    ...
    nodes: [
      ...
      { selector: ".bio article p:nth-of-type(4)", text: { fr: "Il réussit à faire classer Art27, notamment avec l'exposition Ecce Homo relayée par la radio RFI.", en: "He succeeded in giving Art27 real standing, notably through the Ecce Homo exhibition, which was relayed by RFI radio." } },
      ...
      { selector: ".bio article p:nth-of-type(9)", text: { fr: "Wallerand nous a malheureusement quittés en novembre 2021. C'était une personne d'une extrême sensibilité et d'une grande bienveillance à l'égard des autres.", en: "Wallerand sadly left us in November 2021. He was a person of great sensitivity and deep kindness toward others." } },
      { selector: ".bio article p:nth-of-type(10)", text: { fr: "Il laisse derrière lui une œuvre riche et variée : peintures, vidéos, photos, installations, poèmes, et de merveilleux souvenirs. La Maison Rose poursuit aujourd'hui cet héritage vivant.", en: "He leaves behind a rich and varied body of work: paintings, videos, photographs, installations, poems, and many luminous memories. The Pink House carries that living legacy forward today." } },
      ...
      { selector: ".works .work:nth-child(6) img", attrs: { alt: { fr: "Œuvre de Wallerand, archive 5", en: "Work by Wallerand, archive 5" } } }
    ]
  }
};
