...
const STATIC_PAGE_COPY = {
  ...
  lieu: {
    ...
    nodes: [
      ...
      { selector: ".page-hero .lede", text: { fr: "À 30 km de Paris, la Maison Rose de Wallerand redonne vie à l'ancien atelier d'été de Charles-François Daubigny.", en: "30 km from Paris, the Pink House of Wallerand gives new life to Charles-François Daubigny's former summer studio." } },
      { selector: ".place-preview-grid .place-shot:nth-child(1) .lbl", text: { fr: "Façade", en: "Front façade" } },
      { selector: ".place-preview-grid .place-shot:nth-child(2) .lbl", text: { fr: "Verrière", en: "Glass roof" } },
      { selector: ".place-preview-grid .place-shot:nth-child(3) .lbl", text: { fr: "Patio", en: "Patio" } },
      { selector: ".place-preview-grid .place-shot:nth-child(4) .lbl", text: { fr: "Entrée", en: "Entrance" } },
      { selector: ".place-preview-grid .place-shot:nth-child(5) .lbl", text: { fr: "Vie du lieu", en: "House in use" } },
      ...
      { selector: ".visit .sec-head .right", text: { fr: "Quelques vues du lieu pour sentir son atmosphère, puis une visite photo plus complète pour découvrir la Maison Rose pièce après pièce.", en: "A few strong views to feel the atmosphere of the place, then a fuller photo visit to discover the Pink House room by room." } },
      ...
      { selector: ".visit-text .btn-primary", html: { fr: "Visiter la Maison Rose <span class=\"arr\">→</span>", en: "Visit the Pink House <span class=\"arr\">→</span>" } },
      ...
      { selector: ".visit-gallery .sec-head .right", text: { fr: "Façade, verrière, patio, entrée, vie du lieu : une visite photo fluide pour prolonger la découverte avant votre venue.", en: "Front façade, glass roof, patio, entrance, daily life of the house: a smooth photo visit to continue the discovery before coming in person." } },
  ...
  stages: {
    ...
    nodes: [
      ...
      { selector: ".page-hero h1", html: { fr: "<span class=\"line\">Cours et stages</span><em class=\"line\">de pratique artistique.</em>", en: "<span class=\"line\">Courses and workshops</span><em class=\"line\">in the arts.</em>" } },
      { selector: ".page-hero .lede", text: { fr: "La gravure ouvre aujourd'hui la programmation, avec une page pensée pour accueillir demain d'autres pratiques artistiques.", en: "Engraving opens the programme today, with a page designed to welcome other artistic practices tomorrow." } },
      { selector: ".filters .filter:nth-child(1)", text: { fr: "Tous les cours et stages", en: "All courses & workshops" } },
      { selector: ".filters .filter:nth-child(2)", text: { fr: "Gravure", en: "Engraving" } },
      { selector: ".filters .filter:nth-child(3)", text: { fr: "Autres pratiques", en: "Other practices" } },
      { selector: ".filters .filter:nth-child(4)", text: { fr: "Ouverts", en: "Open" } },
  ...
  assoc: {
    ...
    nodes: [
      ...
      { selector: ".miss .sec-head .right", text: { fr: "Une programmation qui favorise l'échange entre patrimoine, artistes invités, habitants et publics de passage.", en: "A programme that encourages exchange between heritage, invited artists, local residents and passing audiences." } },
      ...
      { selector: ".team .sec-head .right", text: { fr: "Une programmation qui favorise l'échange entre patrimoine, création contemporaine et accès simple à la culture.", en: "A programme that encourages exchange between heritage, contemporary creation and straightforward access to culture." } },
